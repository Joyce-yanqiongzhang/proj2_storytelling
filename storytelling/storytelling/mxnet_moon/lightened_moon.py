...
# loggermx = logging.getLogger()
# loggermx.setLevel(logging.INFO)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--list-dir', type=str, default='/home/adruser/AttGAN-Tensorflow/data/img_align_celeba/',
                        help='the directory which contain the training list file')
    parser.add_argument('--model-save-prefix', type=str, default='../model/lightened_moon/lightened_moon_fuse-symbol.json',
    ...
    parser.add_argument('--model-load-prefix', type=str, default='../model/lightened_moon/lightened_moon_fuse', help='the prefix of the model to load')
