...
parser.add_argument('--save', type=str,  default='../models/'+randomhash+'.pkl',
...
def model_save(fn):
    ...
    torch.save([model, criterion, optimizer], fn)

def model_load(fn):
    global model, criterion, optimizer
    # with open(fn, 'rb') as f:
    model, criterion, optimizer = torch.load(fn)
        ...
        if 't0' in optimizer.param_groups[0]:
            ...
            for prm in model.parameters():
                ...
                try:
                    ...
                    print("did not update this prm.data")
                # break
                # prm.data = optimizer.state[prm]['ax'].clone()
            ...
            for prm in model.parameters():
                try:
                    ...
                    print("did not retrieve this prm.data")
